...
class CollectiViewController: UIView {
...
extension CollectiViewController: UICollectionViewDelegate, UICollectionViewDataSource {
    // item 수만큼 출력
...
extension CollectiViewController: UICollectionViewDelegateFlowLayout {
    // cell layout
