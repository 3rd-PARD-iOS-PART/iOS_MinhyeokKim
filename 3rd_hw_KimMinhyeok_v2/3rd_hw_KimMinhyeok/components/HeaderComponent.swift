    ...
    @objc func headerButtonTapped(_ sender: UIButton) {
        ...
        if let title = sender.title(for: .normal), let viewController = viewController {
            ...
            case "TV Shows":
                ...
                viewController.navigationController?.pushViewController(tvShowsViewController, animated: true)
            case "Movies":
            ...
            case "My List":
                ...
                viewController.navigationController?.pushViewController(myListViewController, animated: true)
            default:
                break
            }
        }
